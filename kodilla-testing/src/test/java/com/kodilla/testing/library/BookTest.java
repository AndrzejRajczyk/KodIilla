...
class BookTest {
    ...
    void testlistBooksInHandsOf() {
       ...
       List<Book> userListBooksHandsOf0 = new ArrayList<Book>();
        List<Book> userListBooksHandsOf1 = generateListOfNBooks(1);
        List<Book> userListBooksHandsOf5 = generateListOfNBooks(5);
        LibraryUser libraryUser0 = new LibraryUser("testName0", "testLastName0", "testpesel0");
        LibraryUser libraryUser1 = new LibraryUser("testName1", "testLastName1", "testpesel1");
        LibraryUser libraryUser5 = new LibraryUser("testName5", "testLastName5", "testpesel5");

        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser0)).thenReturn(userListBooksHandsOf0);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser1)).thenReturn(userListBooksHandsOf1);
        when(libraryDatabaseMock.listBooksInHandsOf(libraryUser5)).thenReturn(userListBooksHandsOf5);
